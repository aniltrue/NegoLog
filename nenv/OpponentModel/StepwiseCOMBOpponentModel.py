...
class StepwiseCOMBOpponentModel(AbstractOpponentModel):  # noqa: D213
    """Stepwise COMB opponent model.

    This model uses Bayesian learning with decoupled hypothesis spaces for
    weights and evaluations. The stepwise variant compares the newest bid to
    the previous bid, using a single-step difference.
    """
